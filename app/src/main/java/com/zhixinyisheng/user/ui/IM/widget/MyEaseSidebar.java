...
public class MyEaseSidebar extends View{
	private Paint paint;
	...
	public MyEaseSidebar(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//		BaseFrameAty.showLog("aaaaaaa","aaaaaa");
		...
		BaseFrameAty.showLog("aaaaaaa",headerString);
