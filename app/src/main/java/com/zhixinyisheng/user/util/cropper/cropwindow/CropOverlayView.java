...
package com.zhixinyisheng.user.util.cropper.cropwindow;
...
import com.zhixinyisheng.user.util.cropper.cropwindow.edge.Edge;
import com.zhixinyisheng.user.util.cropper.cropwindow.handle.Handle;
import com.zhixinyisheng.user.util.cropper.util.AspectRatioUtil;
import com.zhixinyisheng.user.util.cropper.util.HandleUtil;
import com.zhixinyisheng.user.util.cropper.util.PaintUtil;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                Intent intent = new Intent(Constant.LAB_CROP);
