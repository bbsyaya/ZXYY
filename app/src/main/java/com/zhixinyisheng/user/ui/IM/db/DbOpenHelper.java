...
public class DbOpenHelper extends SQLiteOpenHelper {
	...
	private static final String USERNAME_TABLE_CREATE = "CREATE TABLE "
			...
			+ UserDao.COLUMN_NAME_NO + " TEXT, "
			+ UserDao.COLUMN_NAME_SOS + " TEXT, "
			+ UserDao.COLUMN_NAME_DATAS + " TEXT, "
			+ UserDao.COLUMN_NAME_AGREEFLAG + " TEXT, "
			+ UserDao.COLUMN_NAME_ISPATIENT + " TEXT, "
			+UserDao.COLUMN_NAME_ISMYDOCTOR+" TEXT, "
			+UserDao.COLUMN_NAME_PAYEDUSERID+" TEXT, "
			+UserDao.COLUMN_NAME_CANSOSSET+" TEXT, "
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		Log.e("newVersion",oldVersion+"&&&"+newVersion);
		if(oldVersion < 2){
