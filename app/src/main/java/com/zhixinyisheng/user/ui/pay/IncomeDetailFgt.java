 ...
 */
public class IncomeDetailFgt extends BaseFgt implements SwipyRefreshLayout.OnRefreshListener,AdapterView.OnItemClickListener {
    ...
    public void initData() {
        try {
            ...
            doHttp(RetrofitUtils.createApi(Pay.class).searchIncome(phone, secret, userId, 10, mPage), HttpIdentifier.SEARCH_INCOME);
    ...
    public void onSuccess(String result, Call<ResponseBody> call, Response<ResponseBody> response, int what) {
        ...
        switch (what) {
            case HttpIdentifier.SEARCH_INCOME:
    ...
    public void onRefresh(SwipyRefreshLayoutDirection direction) {
        if (direction == SwipyRefreshLayoutDirection.TOP) {
            mPage = 1;
            doHttp(RetrofitUtils.createApi(Pay.class).searchIncome(phone, secret, userId, 10, mPage), 0);
