...
//                LogUtil.e(TAG,"isFirst="+isFirst+",mySortedMap cost:"+ (System.currentTimeMillis()-start));
                if(mySortedMap != null && !mySortedMap.isEmpty()) {
                    ...
                    if (topPackageName==null){
                        ...
                        if ("com.android.systemui".equals(topPackageName)){
                            ...
                            if (tempPackage!=null){
                                if (MyApplication.getApp().getPackageName().equals(tempPackage)){
                    ...
                    Logger.d(TAG,topPackageName);
                }else {
                    Logger.d(TAG,"mySortedMap.isEmpty");
                    if (isFirst){
            ...
            if (runningTopActivity.getPackageName().equals(MyApplication.getApp().getPackageName())){
                runningTopActivity = getTopRunningTasks();
            }
        }else {
            runningTopActivity = getTopRunningTasks();
    ...
    public ComponentName getTopRunningTasks(){
        ...
        Logger.d(TAG,"runningTopActivity="+runningTopActivity.getClassName());
        return runningTopActivity;
    }
