 ...
 */
public class LaboratoryCropSecondAty extends BaseAty{
    @Bind(R.id.civ_lab)
...
//                    dismissLoadingDialog();
                    ...
                    Content.resultData = textResult;
                    Log.e("second", textResult);
...
//                    showLoadingDialog(null);
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        titleBtn.setText(getString(R.string.xiayibu));
        cjsTvt.setText(R.string.jieguo);
        tvToast.setText(R.string.qingjiequjieguozheyilie);
...
//    public void finish() {
//        super.finish();
//        AppManger.getInstance().killActivity(LaboratoryCropFirstAty.class);
//    }
...
//        ivCeshi.setImageBitmap(cropperImage.getBitmap());
                ...
                String labLocalPath2 = FileUtils.saveFile(this, "lab2.png", bitmapSelected);
                Content.resultData = labLocalPath2;
...
//                }).start();
                ...
                startActivity(LaboratoryCropThirdAty.class,bundle);
                finish();
                break;
        }
    }
