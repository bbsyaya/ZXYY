 ...
 * @desicription : 适配器基类
 */
public abstract class ArrayListAdapter2<T> extends BaseAdapter {
    private Context context;
    private LayoutInflater inflater;
    private int layoutResId;
    Object viewHolder;
    public ArrayListAdapter2(Context context, int layoutResId) {
    ...
    public abstract void createViewHolder(View convertView);
