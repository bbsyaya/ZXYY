...
package com.zhixinyisheng.user.util.cropper.util;
...
public class PaintUtil {
    ...
    private static final String SEMI_TRANSPARENT = "#00c5cd";
    private static final String DEFAULT_BACKGROUND_COLOR_ID = "#00000000";
    ...
    public static Paint newCornerPaint(Context context) {
        ...
        cornerPaint.setColor(Color.parseColor("#00c5cd"));
