...
public class BLEForSoSService extends Service {
    private final static String TAG = BLEForSoSService.class.getSimpleName();
    ...
    public final static String RSSI_DATA=
            "com.nordicsemi.nrfUART.RSSI_DATA";
...
// Log.d(TAG, String.format("Received TX: %d",characteristic.getValue()
    ...
    public class LocalBinder extends Binder {
        BLEForSoSService getService() {
            return BLEForSoSService.this;
        }
    }
    ...
    public void enableTXNotification()
    {
        ...
        //	Log.w(TAG, "UUID = " + service.getUuid() );
        ...
        System.out.println("discover rxservice succeed");
        ...
        System.out.println("discover TxChar succeed");
        mBluetoothGatt.setCharacteristicNotification(TxChar,true);
        System.out.println(TxChar.getUuid());
        List<BluetoothGattDescriptor> mDescriptors=TxChar.getDescriptors();
        for (BluetoothGattDescriptor mDescriptor : mDescriptors) {
            System.out.println(mDescriptor.getUuid());
        }

        BluetoothGattDescriptor descriptor = TxChar.getDescriptor(CCCD);
        System.out.println(descriptor.getUuid());
        System.out.println("discover cccd succeed");
        descriptor.setValue(BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE);
        System.out.println("ENABLE_NOTIFICATION");
        mBluetoothGatt.writeDescriptor(descriptor);
        System.out.println("discover writeDescriptor succeed");
    }
