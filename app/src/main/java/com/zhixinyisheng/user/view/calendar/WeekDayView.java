...
public class WeekDayView extends View {
	// 上横线颜色
	private int mTopLineColor = Color.parseColor("#5dbaba");
	// 下横线颜色
	private int mBottomLineColor = Color.parseColor("#CCE4F2");
	// 周一到周五的颜色
	private int mWeedayColor = Color.parseColor("#000000");
	// 周六、周日的颜色
	private int mWeekendColor = Color.parseColor("#ff9900");
	// 线的宽度
	private int mStrokeWidth = 4;
	private int mWeekSize = 15;
	private Paint paint;
	private DisplayMetrics mDisplayMetrics;
	private String[] weekString = new String[] { getContext().getString(R.string.ri), getContext().getString(R.string.yi),
			getContext().getString(R.string.er), getContext().getString(R.string.san), getContext().getString(R.string.si), getContext().getString(R.string.five),
			getContext().getString(R.string.liu) };
...
//		canvas.dr(0, height, width, height, paint);
//		paint.setStyle(Style.FILL);
		...
		for (int i = 0; i < weekString.length; i++) {
			...
			if (text.indexOf(getContext().getString(R.string.liu)) > -1 || text.indexOf(getContext().getString(R.string.ri)) > -1) {
