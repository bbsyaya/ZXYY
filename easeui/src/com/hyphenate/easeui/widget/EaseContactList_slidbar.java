...
public class EaseContactList_slidbar extends RelativeLayout {
    protected static final String TAG = EaseContactList_slidbar.class.getSimpleName();
    ...
    public EaseContactList_slidbar(Context context) {
        super(context);
        init(context, null);
    }

    public EaseContactList_slidbar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EaseContactList_slidbar(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }
