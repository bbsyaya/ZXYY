...
public class WheelRecyclerView extends RecyclerView {
    ...
    public WheelRecyclerView(Context context, @Nullable AttributeSet attrs) {
        ...
        mDividerWidth = ta.getDimension(R.styleable.WheelRecyclerView_selectWidth, DEFAULT_DIVIDER_WIDTH);
        mDividerHeight = ta.getDimension(R.styleable.WheelRecyclerView_selectHeight, DEFAULT_DIVIDER_HEIGHT);
        mDividerColor = ta.getColor(R.styleable.WheelRecyclerView_selectColor, DEFAULT_DIVIVER_COLOR);
