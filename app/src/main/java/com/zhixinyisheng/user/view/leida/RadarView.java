package com.zhixinyisheng.user.view.leida;
...
public class RadarView extends View {
    ...
    private float mBitmapWidth  ;//中心图片默认的宽度，这里是px
    private float mCircleMargin ;//距离宽度，默认是px
    private float mCircleWidth    = 2;//圆圈的画笔宽度，默认px
    private int   mCircleColor    = 0x0025CDBC; //最内层圈圈的颜色，下面依次
    private int   mCircleColorx   = 0x0025CDBC;
    private int   mCircleColorxx  = 0x0025CDBC;
    private int   mCircleColorxxx = 0x0025CDBC;
    private int   mScanColor      = 0xff00C5CD;
    ...
    private void initView() {
        ...
        mPaintCircle.setStrokeWidth(DensityUtils.dp2px(50));
    ...
    public void setmImageUrl(int resource) {
        this.resource = resource;
        getBitmapFromGlide(this.resource);
    }
