...
import com.hyphenate.easeui.adapter.MyEaseContactAdapter;
 ...
 * 创建人: Fu
 * <p/>
 * 创建时间: 2016/11/10  10:02
 * <p/>
 * 类说明:
 */
public class MyEaseContactList extends RelativeLayout {
    protected static final String TAG = EaseContactList.class.getSimpleName();

    protected Context context;
    protected ListView listView;
    protected MyEaseContactAdapter adapter;
    ...
    public MyEaseContactList(Context context) {
        super(context);
        init(context, null);
    }

    public MyEaseContactList(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MyEaseContactList(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }
    ...
    public void init(List<EaseUser> contactList){
        ...
        adapter = new MyEaseContactAdapter(context, 0, new ArrayList<EaseUser>(contactList));
