...
public class ThemeConfig implements Serializable{
    ...
    public static ThemeConfig CYAN = new ThemeConfig.Builder()
            .setTitleBarBgColor(Color.rgb(0x25, 0xcd, 0xbc))
            .setFabNornalColor(Color.rgb(0x25, 0xcd, 0xbc))
            .setFabPressedColor(Color.rgb(0x25, 0xcd, 0xbc))
            .setCheckSelectedColor(Color.rgb(0x25, 0xcd, 0xbc))
            .setCropControlColor(Color.rgb(0x25, 0xcd, 0xbc))
            .build();
    //橙色主题
