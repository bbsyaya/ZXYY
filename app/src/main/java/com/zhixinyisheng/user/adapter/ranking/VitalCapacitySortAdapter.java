...
public class VitalCapacitySortAdapter extends CommonAdapter<VitalCapacitySort.ListBean> {
    private TextView tvSort,tvNick,tvSteps;
    private ImageView ivAvatar;
    private Context context;
    public VitalCapacitySortAdapter(Context context, List<VitalCapacitySort.ListBean> mList, int itemLayoutId) {
        super(context, mList, itemLayoutId);
        this.context = context;
    }

    @Override
    public void convert(ViewHolder holder, VitalCapacitySort.ListBean item, int positon) {
        ...
        tvSteps.setText((int)item.getNUM()+"");
